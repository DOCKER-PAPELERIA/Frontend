...
/**
 * Instancia de la clase Link para redirigir al formulario de visualizar categorías.
 */
new Link("../HTML/_18_categoriasVisualizarCategorias.html", "#vercategBtn").redireccionar();

/**
 * Instancia de la clase Link para redirigir al formulario de nueva categoría.
 */
new Link("../HTML/_20_categoriasNuevaCategoria.html", "#nuevacategBtn").redireccionar();

/**
 * Instancia de la clase Link para redirigir al formulario de cambiar información de categoría.
 */
